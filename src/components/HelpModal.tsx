        ...
        <div className="p-4 sm:p-6">
          <div className="flex justify-between items-center mb-4 sm:mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">使い方ガイド</h2>
            </div>
            <button
              onClick={onClose}
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                ...
                <div className="bg-green-50 bg-opacity-50 p-3 sm:p-4 rounded-xl text-center border border-green-200 border-opacity-50 hover:shadow-lg transition-all duration-300 hover:scale-105">
                  ...
                  <div className="text-xs text-green-600 mt-1">保存して完了</div>
                </div>
              </div>
            </section>
